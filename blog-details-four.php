    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <div class="container">
                ...
                <h2 class="page-header__title">Inside Himachal’s First Pet-First Café: A One-of-a-Kind Experience</h2>
            </div><!-- /.container -->
        </section><!-- /.page-header -->
                    ...
                    <div class="heritage-taeragh-grid">
                        ...
                        <div class="heritage-taeragh-card">
                            <div class="heritage-taeragh-img">
                                <img src="assets/Shyamalaimages/PrivateWoodenCabinPetCafe/hlng.jpeg" alt="">
                            </div>
                            <div class="heritage-taeragh-content">
                                <h3><a href="blog-details-second.php">A Place Where Pets Lead the Experience</a></h3>
                                <p>No restrictions, no judgment — dogs can run unleashed, splash, play, rest, and just be their happiest selves. Humans follow their joy.</p>
                            </div>
                        </div>
                        ...
                        <div class="heritage-taeragh-card">
                            <div class="heritage-taeragh-img">
                                <img src="assets/Shyamalaimages/PrivateWoodenCabinPetCafe/stay.jpeg" alt="">
                            </div>
                            <div class="heritage-taeragh-content">
                                <h3><a href="blog-details-right.html">Private Cabins for Comfort & Quality Time</a></h3>
                                <p>Guests enjoy cozy, stylish private cabins overlooking forest views. Whether it’s a date, a family visit, or quiet me-time with your pet — it creates a memorable setting.</p>
                            </div>
                        </div>
                        ...
                        <div class="heritage-taeragh-card">
                            <div class="heritage-taeragh-img">
                                <img src="assets/Shyamalaimages/OpenAirSpashPool/spl.jpeg" alt="">
                            </div>
                            <div class="heritage-taeragh-content">
                                <h3><a href="blog-details-right.html">The Signature Splash Pool</a></h3>
                                <p>Summer days turn magical with a dedicated splash pool for dogs. It’s safe, supervised, and designed purely for fun and enrichment.</p>
                            </div>
                        </div>
                        ...
                        <div class="heritage-taeragh-card">
                            <div class="heritage-taeragh-img">
                                <img src="assets/Shyamalaimages/PetBakeryFoodPictures/Retreat.jpeg" alt="">
                            </div>
                            <div class="heritage-taeragh-content">
                                <h3><a href="blog-details-right.html">Fresh Pet Bakery & Pet Menu</a></h3>
                                <p>From birthday cakes to cookies, from ice-creams to healthy meals — everything is baked fresh, dog-safe, and preservative-free.</p>
                            </div>
                        </div>
                        ...
                        <div class="heritage-taeragh-card">
                            <div class="heritage-taeragh-img">
                                <img src="assets/Shyamalaimages/PrivateWoodenCabinPetCafe/newdg.jpeg" alt="">
                            </div>
                            <div class="heritage-taeragh-content">
                                <h3><a href="blog-details-right.html">Therapy Dogs, Community, and Heart</a></h3>
                                <p>Guests without pets can bond with Shyamala’s therapy dog family — Cocaine, Jerry, Dot, and Scotch — each offering emotional comfort and joy.</p>
                            </div>
                        </div>
                        ...
                        <div class="premium-quote-card-v2">
                            ...
                            <h3>
                                <a href="blog-details-first.php">
                                    The café has become a community hub where kindness toward animals is the culture.
                                </a>
                            </h3>
