...
<head>
    ...
    <title>Our FAQs || Villoz || HTML Template For Villa & Vacation Rentals</title>
        ...
        <section class="page-header">
            ...
            <div class="container">
                <ul class="villoz-breadcrumb list-unstyled">
                    ...
                    <li><span>Our FAQs</span></li>
                </ul>
                <h2 class="page-header__title">Our FAQs</h2>
            </div>
        </section>
        <section class="faq-page-search">
            <div class="container wow fadeInUp">
                <div class="sec-title text-center">
                    <h6 class="sec-title__tagline">Question & Answer</h6>
                    <h3 class="sec-title__title">Search Your Questions <br>Queries here</h3>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="faq-page__contact">
                            <img src="assets/images/resources/faq.jpg" alt="villoz">
                            <h3 class="faq-page__contact__title">Have Questions? <br>Call Now!</h3>
                            <div class="faq-page__contact__text">
                                <i class="icon-phone-call"></i>
                                <p class="faq-page__contact__number">
                                    Have Question?<br>Free <a href="tel:+9288009850"> +92 (8800) - 9850</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="faq-page__accordion villoz-accrodion" data-grp-name="villoz-accrodion">
                            <div class="accrodion">
                                <div class="accrodion-title">
                                    <h4>
                                        How to make a direct online reservation?
                                ...
                                <div class="accrodion-content">
                                    <div class="inner">
                                        <p>
                                            ...
                                            or randomised words believable. Phasellus a rhoncus erat. Vivamus vel eros vitae est aliquet pellentesque vitae.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="accrodion active">
                                <div class="accrodion-title">
                                    <h4>What are the benefits of early booking?
                                        <span class="accrodion-title__icon"></span>
                                    </h4>
                                </div>
                                <div class="accrodion-content">
                            ...
                            <div class="accrodion">
                                <div class="accrodion-title">
                                    <h4>Will my credit card be charged prior to my arrival at the hotel?
                                        <span class="accrodion-title__icon"></span>
                                    </h4>
                                </div>
                                <div class="accrodion-content">
                            ...
                            <div class="accrodion">
                                <div class="accrodion-title">
                                    <h4>
                                        What is the villa room rate and taxes?
                                        <span class="accrodion-title__icon"></span>
                                    </h4>
                                </div>
                                <div class="accrodion-content">
