    ...
    <div class="page-wrapper">
            ...
            <header class="main-header__bottom sticky-header sticky-header--normal">
                <div class="container-fluid">
                    <div class="main-header__logo">
                        <a href="index.html">
                            <img src="assets/images/shymlalogo-1.png" alt="Villoz HTML" width="125">
                        </a>
        ...
        <section class="page-header">
            ...
            <div class="container">
                ...
                <h2 class="page-header__title">Products Grid</h2>
            </div><!-- /.container -->
        </section><!-- /.page-header -->
                        ...
                        <div class="row gutter-y-30">
                            <div class="col-md-6 col-lg-3">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                                    <div class="product__item__img">
                                        <img src="assets/images/products/product-1-1.jpg" alt="nisoz">
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.html">Boss Sofa</a></h4><!-- /.product-title -->
                                        <div class="product__item__price">$82.00</div><!-- /.product-price -->
                                        <a href="cart.html" class="villoz-btn product__item__link">
                                            <i>Add to Cart</i><span>Add to Cart</span></a>
                                    </div><!-- /.product-content -->
                                </div><!-- /.product-item -->
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                                    <div class="product__item__img">
                                        <img src="assets/images/products/product-1-2.jpg" alt="nisoz">
                                        <div class="product__item__btn">
                                            <a href="cart.html"><i class="far fa-heart"></i></a>
                                            <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                        </div>
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.html">Office Chair</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                                    <div class="product__item__img">
                                        <img src="assets/images/products/product-1-3.jpg" alt="nisoz">
                                        <div class="product__item__btn">
                                            <a href="cart.html"><i class="far fa-heart"></i></a>
                                            <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                        </div>
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.html">Long Stool</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'>
                                    <div class="product__item__img">
                                        <img src="assets/images/products/product-1-4.jpg" alt="nisoz">
                                        <div class="product__item__btn">
                                            <a href="cart.html"><i class="far fa-heart"></i></a>
                                            <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                        </div>
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.html">Round Chair</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='400ms'>
                                    <div class="product__item__img">
                                        <img src="assets/images/products/product-1-5.jpg" alt="nisoz">
                                        <div class="product__item__btn">
                                            <a href="cart.html"><i class="far fa-heart"></i></a>
                                            <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                        </div>
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.html">Sofa Chair</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='500ms'>
                                    <div class="product__item__img">
                                        <img src="assets/images/products/product-1-6.jpg" alt="nisoz">
                                        <div class="product__item__btn">
                                            <a href="cart.html"><i class="far fa-heart"></i></a>
                                            <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                        </div>
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.html">White Chair</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='600ms'>
                                    <div class="product__item__img">
                                        <img src="assets/images/products/product-1-7.jpg" alt="nisoz">
                                        <div class="product__item__btn">
                                            <a href="cart.html"><i class="far fa-heart"></i></a>
                                            <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                        </div>
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.html">Wood Stool</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='700ms'>
                                    <div class="product__item__img">
                                        <img src="assets/images/products/product-1-8.jpg" alt="nisoz">
                                        <div class="product__item__btn">
                                            <a href="cart.html"><i class="far fa-heart"></i></a>
                                            <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                        </div>
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.html">Sofa Seat</a></h4><!-- /.product-title -->
            ...
            <div class="main-footer__top">
                <div class="container">
                    <a href="index.html" class="main-footer__logo">
                        <img src="assets/images/shymlalogo-1.png" width="125" alt="Villoz HTML Template">
                    </a>
