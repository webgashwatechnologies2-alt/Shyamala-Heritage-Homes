    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <div class="container">
                ...
                <h2 class="page-header__title">Five Reasons a Heritage Home Makes the Perfect Getaway</h2>
            </div><!-- /.container -->
        </section><!-- /.page-header -->
                    ...
                    <div class="heritage-taeragh-grid">
                        ...
                        <div class="heritage-taeragh-card">
                            <div class="heritage-taeragh-img">
                                <img src="assets/Shyamalaimages/Villa/hme1.jpeg" alt="">
                            </div>
                            <div class="heritage-taeragh-content">
                                <h3><a href="blog-details-second.php">Architecture That Feels Alive</a></h3>
                                <p>Heritage buildings are crafted with soul — wooden beams, colonial windows, skylit rooms, and hand-built pathways that make your stay feel intimate and meaningful.</p>
                            </div>
                        </div>
                        ...
                        <div class="heritage-taeragh-card">
                            <div class="heritage-taeragh-img">
                                <img src="assets/Shyamalaimages/DelxueRoomWithForestViews/nuyy.jpeg" alt="">
                            </div>
                            <div class="heritage-taeragh-content">
                                <h3><a href="blog-details-right.html">Slow Living at Its Finest</a></h3>
                                <p>Heritage homes invite you to breathe slow — sunshine-filled verandahs, morning birdsong, mountain breezes, and a peaceful pace that feels deeply refreshing.</p>
                            </div>
                        </div>
                        ...
                        <div class="heritage-taeragh-card">
                            <div class="heritage-taeragh-img">
                                <img src="assets/Shyamalaimages/CanopyeCottage/vlntr1.jpeg" alt="">
                            </div>
                            <div class="heritage-taeragh-content">
                                <h3><a href="blog-details-right.html">A Real Connection to Local Culture</a></h3>
                                <p>Heritage stays preserve local traditions, stories, and craftsmanship. You feel Himachal not as a visitor — but as someone living inside its legacy.</p>
                            </div>
                        </div>
                        ...
                        <div class="heritage-taeragh-card">
                            <div class="heritage-taeragh-img">
                                <img src="assets/Shyamalaimages/CanopyeCottage/lat.jpeg" alt="">
                            </div>
                            <div class="heritage-taeragh-content">
                                <h3><a href="blog-details-right.html">Naturally Beautiful Surroundings</a></h3>
                                <p>These properties sit amid forests, gardens, and open mountain landscapes — where nature isn’t decoration but the heart of your stay.</p>
                            </div>
                        </div>
                        ...
                        <div class="heritage-taeragh-card">
                            <div class="heritage-taeragh-img">
                                <img src="assets/Shyamalaimages/Villa/vla1.jpeg" alt="">
                            </div>
                            <div class="heritage-taeragh-content">
                                <h3><a href="blog-details-right.html">Warm, Personal Hospitality</a></h3>
                                <p>Run with emotion, not scripts — heritage stays welcome you like family, with personal warmth in every meal, moment, and mountain walk.</p>
                            </div>
                        </div>
                        ...
                        <div class="premium-quote-card-v2">
                            ...
                            <h3>
                                <a href="blog-details-first.php">
                                   A heritage home isn’t just where you stay — it becomes part of your memory of the trip.
                                </a>
                            </h3>
